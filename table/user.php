...
<div class="container">
    ...
    <h1><strong>Liste des utilisateurs  </strong><a href="ajout-utilisateur.php" class="btn btn-success btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Ajouter</a></h1>
        ...
        <table class="table container-fluid content-justify-center table-responsive table-hover table-borderless">
            ...
            <tbody>
                ...
                <?php
                    $db= Database::connect();
                    $recupUtilisateur = $db->query('SELECT * FROM  user ORDER by dateinscriptionuser');
                    while($user = $recupUtilisateur-> fetch())
                    {
                        ...
                        echo '</td><td>';
                        echo '<a class="btn btn btn-outline-dark btn-sm ml-1" href="view-utilisateur.php?id=' .$user['idUtilisateur'] .'&back=admin"><i class="fa fa-eye" aria-hidden="true"></i> Voir</a>';
                            ...
                            echo  '<div class="modal fade" id="exampleModalCenter'.$user['idUtilisateur'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                             <div class="modal-dialog modal-dialog-centered" role="document">
                                 ...
                                 <div class="modal-header">
                                     <h5 class="modal-title" id="exampleModalLongTitle'.$user['idUtilisateur'].'">Supprimer un utilisateur</h5>
